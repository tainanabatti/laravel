                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="center">{{$cli->id}}</td>
                                        <td title="Nome">{{$cli->nome}}</td>
                                        <td title="Telefone">{{$cli->telefone}}</td>
                                        <td title="Rua">{{$cli->rua}}</td>
                                        <td title="Complemento">{{$cli->complemento}}</td>
                                        <td title="Bairro">{{$cli->bairro}}</td>
                                        <td title="CEP">{{$cli->cep}}</td>
                                        <td title="Cidade">{{$cli->cidade}}</td>
                                        <td title="Estado">{{$cli->estado}}</td>
                                        <td id="center">
                                            <a href="{{route('cliente.edit', $cli->id)}}"
                                               data-toggle="tooltip" 
                                               data-placement="top"
                                               title="Alterar"><i class="fa fa-pencil"></i></a>
                                            &nbsp;<form style="display: inline-block;" method="POST" 
                                                        action="{{route('cliente.destroy', $cli->id)}}"
